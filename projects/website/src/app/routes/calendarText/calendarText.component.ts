...
@Component({
  selector: 'kinam-calendarText',
  templateUrl: './calendarText.component.html',
  styleUrls: ['./calendarText.component.scss']
})
export class CalendarTextComponent implements OnInit {
